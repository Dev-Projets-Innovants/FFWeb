...
const Hero = () => {
  ...
  return (
    <div 
      className="relative min-h-[90vh] flex items-center justify-center bg-cover bg-center py-16 px-4" 
      style={{
    ...
    >
      ...
      <div className="container mx-auto max-w-3xl z-10 text-center px-4">
        <h1 
          ref={titleRef} 
          className="opacity-0 text-4xl sm:text-5xl md:text-5xl lg:text-6xl font-bold mb-6 text-white leading-tight"
        >
        ...
        <p 
          ref={subtitleRef}
          className="opacity-0 text-lg md:text-xl text-white/90 mb-8 max-w-2xl mx-auto"
        >
