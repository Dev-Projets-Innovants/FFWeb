  ...
  return <div className="relative min-h-[90vh] flex items-center justify-center bg-cover bg-center py-12 md:py-16 px-4" style={{
    ...
    backgroundSize: "cover"
      ...
      <div className="container mx-auto max-w-3xl z-10 text-center px-4 pt-16 md:pt-0">
        <h1 ref={titleRef} className="opacity-0 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 md:mb-6 text-white leading-tight">
        ...
        <p ref={subtitleRef} className="opacity-0 text-base md:text-lg lg:text-xl text-white/90 mb-6 md:mb-8 max-w-2xl mx-auto">
