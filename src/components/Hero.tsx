...
const Hero = () => {
  ...
  return (
    <div className="relative min-h-[90vh] flex items-center justify-center bg-cover bg-center py-16 px-4" style={{
      ...
      <div className="container mx-auto max-w-3xl z-10 text-center px-4">
        ...
        <div ref={ctaRef} className="opacity-0 flex flex-col sm:flex-row justify-center gap-4 mb-8">
          ...
          behavior: 'smooth'
        })} size="lg" className="border-white hover:bg-white/20 text-base px-8 py-6 text-white">
            Explore Projects
          </Button>
        </div>
      </div>
